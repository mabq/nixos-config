...
/*
  ...
  `/etc/zshenv`
    ...
    we don't use). What you need to understand is that, NixOS automatically
    configures this file to source `/etc/set-environment`. Read notes in the
    imported "session-variables.nix" module.
